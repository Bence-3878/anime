...
if(isset($_POST['felvesz'])){
    $sql = "INSERT INTO anime_lista (felhasznalo_id, anime_id";
        if(isset($_POST['ertesites'])) $sql.= ", ertekeles";
        if(isset($_POST['hol_tartasz'])) $sql.=", hol_tart";
        $sql.=", statusz) VALUES (:user_id, :anime_id";
        if(isset($_POST['ertesites'])) $sql.= ", :ertesites";
        if(isset($_POST['hol_tartasz'])) $sql.= ", :hol_tartasz";
        $sql.=", NULL)";
