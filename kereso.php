...
<div class="container" id="kereso">
    <?php if (isset($_POST["kereso"])):
        ...
        $sql =
            "SELECT * FROM anime WHERE romanji_cim LIKE :kereso1 OR angol_cim LIKE :kereso2";
        ...
        <main class="row">
            <ul class="anime-list">
                <?php foreach ($anime as $anime_elem): ?>
                    <li class="anime-item"><img src="<?= $anime_elem[
                        "poszter"
                        ] ?>" class="anime-poszter">
                        <a href="anime.php?id=<?= $anime_elem[
                        "id"
                        ] ?>"><?= $anime_elem["romanji_cim"] ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </main>
